...
using System;
using SettlementBookingSystem.Core;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddProblemDetails(options =>
            {
                ...
                options.Map<DomainExceptions.DuplicationException>(ex => new ConflictProblemDetails(ex));
                options.Map<ValidationException>(ex => new BadRequestProblemDetails(ex));
                options.Map<DomainExceptions.ValidationException>(ex => new BadRequestProblemDetails(ex));
                options.Map<AggregateException>(ex =>
                {
                    return ex.InnerException switch
                    {
                        ...
                        DomainExceptions.DuplicationException duplication => new ConflictProblemDetails(duplication),
                        ValidationException validation => new BadRequestProblemDetails(validation),
                        DomainExceptions.ValidationException domainValidation => new BadRequestProblemDetails(domainValidation),
